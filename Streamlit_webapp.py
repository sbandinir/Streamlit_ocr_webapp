...
if uploaded_file is not None:
  ...
  df2=df_output.iloc[:, 5 : 8]
  df3=df_output.iloc[:, 9 : 12]
  df4=df_output.iloc[:, 13 : 16]
  df5=df_output.iloc[:, 17 : 20]
  df6=df_output.iloc[:, 21 : 24]
  df7=df_output.iloc[:, 25 : 28]
  df8=df_output.iloc[:, 29 : 32]
  df9=df_output.iloc[:, 33 : 36]
