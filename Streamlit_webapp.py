...
if uploaded_file is not None:
  ...
  df1=df_output.iloc[:, : 4]
  df2=df_output.iloc[:, 4 : 8]
  df3=df_output.iloc[:, 8 : 12]
  df4=df_output.iloc[:, 12 : 16]
  df5=df_output.iloc[:, 16 : 20]
  df6=df_output.iloc[:, 20 : 24]
  df7=df_output.iloc[:, 24 : 28]
  df8=df_output.iloc[:, 28 : 32]
  df9=df_output.iloc[:, 32 : 36]
