...
coordinates= {
    ...
    'PA Media Notte - ABPM: PAM media NOTTE STD' : (925,1569,979,1605),
...
pytesseract.pytesseract.tesseract_cmd = r'sbandinir\streamlit_ocr_webapp\tesseract.exe'
...
if uploaded_file is not None:
  #images = pdf2image.convert_from_bytes(uploaded_file.read() ,poppler_path=r'C:\Program Files\poppler-0.68.0\bin')
  images = pdf2image.convert_from_bytes(uploaded_file.read(),poppler_path=r'sbandinir\streamlit_ocr_webapp')
